...
URL_CATEGORIZER_RULES = [  # hostname, path, query, slug, desc
    ...
    ('plut.info', '/urq/.*/files/.*', '', 'download_direct',
     'Скачать с плута'),
    ...
    ('instead-games.ru', '.*/download/.*', '', 'download_direct',
     'Скачать с инстеда'),
    ('quest-book.ru', '/online/view/.*', '', 'game_page',
     'Страница на квестбуке'),
    ('quest-book.ru', '/online/mitril/download/.*/pdf/', '', 'download_direct',
     'PDF версия'),
    ('quest-book.ru', '/online/[^/]+/', '', 'play_online',
     'Играть на квестбуке'),
